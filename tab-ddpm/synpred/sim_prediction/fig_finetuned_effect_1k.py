...
data_folder = f"mydata_toCombine{seed}_1k5w1w_lr{lr}_lr3e-4_{n_feature}_{sigma}"
synthetic_sample_dir = f"./ckpt_{data_folder}/{keyword}_finetuned"
...
data_folder = f"mydata_toCombine{seed}_1k5w10w_lr{lr}_lr3e-4_{n_feature}_{sigma}"
synthetic_sample_dir = f"./ckpt_{data_folder}/{keyword}_finetuned"
