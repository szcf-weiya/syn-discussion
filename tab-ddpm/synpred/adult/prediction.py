...
fake_to_real_ratio_list = np.arange(0.1, 1.9, 0.1)
...
def objective(fake_to_real_ratio=0, add_original_train=False):
...
if __name__ == "__main__":
    study_list = []
    scores = []
    save_path_score = "scores_w0.1-1.9.pkl"
    save_path_ratio = "ratios_w0.1-1.9.pkl"
...
#        )
#
        scores.append(objective(fake_to_real_ratio=fake_to_real_ratio))
        #fake_to_real_ratio_list_raw.append(fake_to_real_ratio)
        
    pickle.dump(fake_to_real_ratio_list, open(save_path_ratio, "wb"))
