...
#ax.plot(ratios_01_09, 1 - np.array(scores_01_09))
ax.plot(ratios_combined[1:], 1 - np.array(scores_combined[1:]), marker = "s", label = "Syn-Boost", ms = 10)
ax.plot(ratios[:10], 1 - np.array(scores[:10]), marker = "x", label = "Syn-Boost (small ratios)", ms = 10)
