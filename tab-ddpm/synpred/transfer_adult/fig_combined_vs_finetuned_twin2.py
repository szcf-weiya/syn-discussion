...
result_female = pickle.load(open(f"./synboost_transfer_adult_female_twin2.pkl", "rb"))
result_female_combined = pickle.load(open(f"./synboost_transfer_adult_female_combined_from_male_twin2.pkl", "rb"))
...
plt.savefig("combined_vs_finetuned-adult-female-twin2.pdf")
