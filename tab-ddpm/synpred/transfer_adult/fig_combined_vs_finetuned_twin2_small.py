...
score_catboost = 0.9266666666666666
score_fnn = 0.9162962962962963
score_catboost_combined = 0.937037037037037
result_female = pickle.load(open(f"./synboost_transfer_adult_female_twin2_small.pkl", "rb"))
result_female_combined = pickle.load(open(f"./synboost_transfer_adult_female_combined_from_male_twin2_small.pkl", "rb"))
...
plt.savefig("combined_vs_finetuned-adult-female-twin2_small.pdf", bbox_inches='tight')
