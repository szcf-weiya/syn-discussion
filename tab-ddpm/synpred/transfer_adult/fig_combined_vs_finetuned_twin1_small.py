...
result_female = pickle.load(open(f"./synboost_transfer_adult_female_twin1_small.pkl", "rb"))
result_female_combined = pickle.load(open(f"./synboost_transfer_adult_female_combined_from_male_twin1_small.pkl", "rb"))
...
ax.set_title(
    "Syn-Boost (adult_female_3000_twin_1)",
    weight="bold",
    fontsize=30,
    loc="left",
    y=1.03,
...
plt.savefig("combined_vs_finetuned-adult-female-twin1_small.pdf", bbox_inches='tight')
