...
twin_id=1
save_path = f"synboost_transfer_adult_female_twin{twin_id}_small.pkl"
...
result_dict = {"rhos": rho_list, "scores": []}
save_path = f"synboost_transfer_adult_female_combined_from_male_twin{twin_id}_small.pkl"
for rho in tqdm(rho_list):
    m = int(n * rho)
